"""
lacuna.models.reconstruction.heads_container

Container for reconstruction heads with natural error computation.

Provides:
- ExtendedReconstructionResult: result with both artificial and natural errors
- ReconstructionHeads: nn.Module container for all reconstruction heads
- create_reconstruction_heads: factory function
"""
...
class ReconstructionHeads(nn.Module):
    ...
    def forward(
        ...
        Args:
            ...
            compute_natural_errors: Whether to compute errors on naturally
                missing cells. Set True for training with discrimination signal.
